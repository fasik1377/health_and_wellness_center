    ...
    return (
        <div className="overflow-hidden">
            <section className="relative isolate overflow-hidden border-b border-stone-200 bg-[linear-gradient(135deg,#2aa198_0%,#135f59_42%,#091311_100%)] text-white">
                ...
                <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(circle_at_top_right,rgba(45,212,191,0.2),transparent_25%),linear-gradient(180deg,rgba(6,20,19,0.05),rgba(6,20,19,0.72))]" />
                ...
                <div className="container relative z-[100] mx-auto grid gap-12 px-4 py-20 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:px-8 lg:py-24">
                    <motion.div
